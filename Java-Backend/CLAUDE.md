...
- [[Java Modern Features - var và record|var & record]] — `Understood`. Reviewed 2026-07-16 → Easy. sr-due 2026-07-22.
- [[Concurrency - Thread và Shared Memory|Concurrency - Thread & Shared Memory]] — `Understood`. Reviewed 2026-07-16 → Good. sr-due 2026-07-22.
...
- [[Design Pattern - Strategy]] — `Understood`. Học mới 2026-07-21 → Good. sr-due 2026-07-23.
- [[Design Pattern - Observer]] — `Understood`. Học mới 2026-07-21 → Good. sr-due 2026-07-23.
- Next up: Design Pattern — Adapter. Bỏ qua volatile/AtomicInteger theo yêu cầu.
