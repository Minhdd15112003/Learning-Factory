...
public class Polymorphism {
    public static void main(String[] args) {
        // Một danh sách kiểu INotify (static type) chứa lẫn Email + Sms (dynamic type
        // khác nhau)
        ...
        n.send("hi");
        // TODO(2): BỎ COMMENT dòng dưới, chạy `javac` lại, ĐỌC lỗi tiếng Anh compiler
        // in ra,
        // rồi comment lại. Ghi vào đây 1 dòng: compiler dựa vào kiểu NÀO của `n` để
        // chặn?
        // n.sendBulk(List.of("a@x.com", "b@x.com")); // sendBulk() chỉ
        // EmailNotification mới có
...
class EmailNotification extends ANotify implements INotify {
    ...
    public void send(String message) {
        ...
        System.out.println(formatTimestamp() + " EMAIL -> " + recipient + ": " + message);
    }
...
class SmsNotification extends ANotify implements INotify {
    ...
    public void send(String message) {
        ...
        System.out.println(formatTimestamp() + " SMS -> " + recipient + ": " + message);
    }
}
