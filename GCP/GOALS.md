...
- Đã xóa toàn bộ lý thuyết GCP cũ (trừ dự án Terraform).
- Bắt đầu lại từ nền tảng đầu tiên: [[GCP Project]].
- Trạng thái tổng thể: xây lại nền tảng GCP từ số 0, song song với dự án thực hành Terraform.
