...
## 4. Reasoning-Gaps
Append any new misconception to `<subject>/04 Reviews/Reasoning-Gaps.md` (Vietnamese). If a gap is significant or recurring, promote it into a full theory note in `00 Ly thuyet/` (Claude authors it, with SR frontmatter). Move a resolved gap to the resolved section with today's date.

## 5. Close
1. Append the user's Feynman answers to today's journal under a `## Feynman Check` section.
