---
description: Weekly refresh of all learning context files for a brain and its sub-projects (status, SR queue overview, weekly review note). Use for /weekly-update [brain].
argument-hint: "[brain]"
---

The user invoked `/weekly-update`. Follow the playbook below EXACTLY — it is the complete operating procedure. Do NOT narrate what you read; carry out the refresh and end on a forward-looking prompt.
